...
class makeOrdererRequest;
struct makeOrdererRequestDefaultTypeInternal;
extern makeOrdererRequestDefaultTypeInternal _makeOrdererRequest_default_instance_;
PROTOBUF_NAMESPACE_OPEN
template<> ::makeOrderResponse* Arena::CreateMaybeMessage<::makeOrderResponse>(Arena*);
template<> ::makeOrdererRequest* Arena::CreateMaybeMessage<::makeOrdererRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE

// ===================================================================

class makeOrdererRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:makeOrdererRequest) */ {
 public:
  inline makeOrdererRequest() : makeOrdererRequest(nullptr) {}
  ~makeOrdererRequest() override;
  explicit PROTOBUF_CONSTEXPR makeOrdererRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  makeOrdererRequest(const makeOrdererRequest& from);
  makeOrdererRequest(makeOrdererRequest&& from) noexcept
    : makeOrdererRequest() {
    *this = ::std::move(from);
  }

  inline makeOrdererRequest& operator=(const makeOrdererRequest& from) {
    CopyFrom(from);
    return *this;
  }
  inline makeOrdererRequest& operator=(makeOrdererRequest&& from) noexcept {
  ...
  static const makeOrdererRequest& default_instance() {
    return *internal_default_instance();
  }
  static inline const makeOrdererRequest* internal_default_instance() {
    return reinterpret_cast<const makeOrdererRequest*>(
               &_makeOrdererRequest_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    0;

  friend void swap(makeOrdererRequest& a, makeOrdererRequest& b) {
    a.Swap(&b);
  }
  inline void Swap(makeOrdererRequest* other) {
  ...
  void UnsafeArenaSwap(makeOrdererRequest* other) {
    if (other == this) return;
  ...
  makeOrdererRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<makeOrdererRequest>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const makeOrdererRequest& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const makeOrdererRequest& from) {
    makeOrdererRequest::MergeImpl(*this, from);
  }
  private:
  ...
  void InternalSwap(makeOrdererRequest* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "makeOrdererRequest";
  }
  protected:
  explicit makeOrdererRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(class_scope:makeOrdererRequest)
 private:
  class _Internal;
...
// int32 price = 1;
inline void makeOrdererRequest::clear_price() {
  _impl_.price_ = 0;
}
inline int32_t makeOrdererRequest::_internal_price() const {
  return _impl_.price_;
}
inline int32_t makeOrdererRequest::price() const {
  // @@protoc_insertion_point(field_get:makeOrdererRequest.price)
  return _internal_price();
}
inline void makeOrdererRequest::_internal_set_price(int32_t value) {
  
  _impl_.price_ = value;
}
inline void makeOrdererRequest::set_price(int32_t value) {
  _internal_set_price(value);
  // @@protoc_insertion_point(field_set:makeOrdererRequest.price)
}

// string goods = 2;
inline void makeOrdererRequest::clear_goods() {
  _impl_.goods_.ClearToEmpty();
}
inline const std::string& makeOrdererRequest::goods() const {
  // @@protoc_insertion_point(field_get:makeOrdererRequest.goods)
  return _internal_goods();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void makeOrdererRequest::set_goods(ArgT0&& arg0, ArgT... args) {
 
 _impl_.goods_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:makeOrdererRequest.goods)
}
inline std::string* makeOrdererRequest::mutable_goods() {
  std::string* _s = _internal_mutable_goods();
  // @@protoc_insertion_point(field_mutable:makeOrdererRequest.goods)
  return _s;
}
inline const std::string& makeOrdererRequest::_internal_goods() const {
  return _impl_.goods_.Get();
}
inline void makeOrdererRequest::_internal_set_goods(const std::string& value) {
  
  _impl_.goods_.Set(value, GetArenaForAllocation());
}
inline std::string* makeOrdererRequest::_internal_mutable_goods() {
  
  return _impl_.goods_.Mutable(GetArenaForAllocation());
}
inline std::string* makeOrdererRequest::release_goods() {
  // @@protoc_insertion_point(field_release:makeOrdererRequest.goods)
  return _impl_.goods_.Release();
}
inline void makeOrdererRequest::set_allocated_goods(std::string* goods) {
  if (goods != nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:makeOrdererRequest.goods)
}
