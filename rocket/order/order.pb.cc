...
PROTOBUF_CONSTEXPR makeOrdererRequest::makeOrdererRequest(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.goods_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.price_)*/0
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct makeOrdererRequestDefaultTypeInternal {
  PROTOBUF_CONSTEXPR makeOrdererRequestDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~makeOrdererRequestDefaultTypeInternal() {}
  union {
    makeOrdererRequest _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 makeOrdererRequestDefaultTypeInternal _makeOrdererRequest_default_instance_;
...
const uint32_t TableStruct_order_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::makeOrdererRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::makeOrdererRequest, _impl_.price_),
  PROTOBUF_FIELD_OFFSET(::makeOrdererRequest, _impl_.goods_),
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::makeOrdererRequest)},
  { 8, -1, -1, sizeof(::makeOrderResponse)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::_makeOrdererRequest_default_instance_._instance,
...
const char descriptor_table_protodef_order_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "er\022\023.makeOrdererRequest\032\022.makeOrderRespo"
...
const ::_pbi::DescriptorTable descriptor_table_order_2eproto = {
    false, false, 216, descriptor_table_protodef_order_2eproto,
    "order.proto",
...
class makeOrdererRequest::_Internal {
 public:
};

makeOrdererRequest::makeOrdererRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:makeOrdererRequest)
}
makeOrdererRequest::makeOrdererRequest(const makeOrdererRequest& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  makeOrdererRequest* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  // @@protoc_insertion_point(copy_constructor:makeOrdererRequest)
}

inline void makeOrdererRequest::SharedCtor(
...
makeOrdererRequest::~makeOrdererRequest() {
  // @@protoc_insertion_point(destructor:makeOrdererRequest)
...
inline void makeOrdererRequest::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.goods_.Destroy();
}

void makeOrdererRequest::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void makeOrdererRequest::Clear() {
// @@protoc_insertion_point(message_clear_start:makeOrdererRequest)
...
const char* makeOrdererRequest::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "makeOrdererRequest.goods"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* makeOrdererRequest::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:makeOrdererRequest)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:makeOrdererRequest)
  return target;
}

size_t makeOrdererRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:makeOrdererRequest)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData makeOrdererRequest::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    makeOrdererRequest::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*makeOrdererRequest::GetClassData() const { return &_class_data_; }


void makeOrdererRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<makeOrdererRequest*>(&to_msg);
  auto& from = static_cast<const makeOrdererRequest&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:makeOrdererRequest)
...
void makeOrdererRequest::CopyFrom(const makeOrdererRequest& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:makeOrdererRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool makeOrdererRequest::IsInitialized() const {
  return true;
}

void makeOrdererRequest::InternalSwap(makeOrdererRequest* other) {
  using std::swap;
...
::PROTOBUF_NAMESPACE_ID::Metadata makeOrdererRequest::GetMetadata() const {
  ...
  switch(method->index()) {
    case 0:
      makeOrder(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::makeOrdererRequest*>(
                 request),
...
const ::PROTOBUF_NAMESPACE_ID::Message& Order::GetRequestPrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::makeOrdererRequest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
template<> PROTOBUF_NOINLINE ::makeOrdererRequest*
Arena::CreateMaybeMessage< ::makeOrdererRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::makeOrdererRequest >(arena);
}
